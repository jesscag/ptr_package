...
def compute_amplitudes(psi_fft, Nx, Ny, deltaky, deltakx):
    ...
    for ikx in range(1,Nx//2):   ##halfway
        for iky in range(1, Ny): ##all but zero
            zhat[iky,ikx] = complex(ran_real[iky,ikx] * psi_root[iky,ikx] + ran_real[Ny-iky, Nx-ikx] * psi_root[Ny-iky, Nx-ikx],
    ...
    for iky in range(1, Ny//2):
        ...
        ikx = 0
        zhat[iky,ikx] = complex(ran_real[iky, ikx] * psi_root[iky, ikx] + ran_real[Ny - iky, ikx] * psi_root[Ny - iky, ikx],
    ...
    for ikx in range(1, Nx//2):
        ...
        iky = 0
        zhat[iky,ikx] = complex(ran_real[iky, ikx] * psi_root[iky, ikx] + ran_real[iky, Nx - ikx] * psi_root[iky, Nx - ikx],
